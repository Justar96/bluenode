...
from codesearch_gym.verify_seeds import verify_seed, verify_all_seeds, print_verification_report, main
...
def test_verify_seed_success_ast(mock_run, mock_path, _mat, tmp_path, sample_bp_ast):
    ...
    mock_path.return_value = tmp_path / "python_unicode"
...
def test_verify_seed_partial_match_rg(mock_run, mock_path, _mat, tmp_path, sample_bp_rg):
    ...
    mock_path.return_value = tmp_path / "react_hooks"
...
def test_verify_all_seeds_counts(mock_vs, _mat):
    mock_vs.side_effect = [
        {"ok": True, "span_f1": 1.0, "file_iou": 1.0, "num_predicted": 1, "num_ground_truth": 1, "seed_id": "a", "errors": []},
        {"ok": True, "span_f1": 0.5, "file_iou": 1.0, "num_predicted": 1, "num_ground_truth": 2, "seed_id": "b", "errors": []},
    ]
...
def test_print_verification_report_format():
    report = {
        ...
        "results": [
            {"seed_id": "a", "ok": True, "span_f1": 1.0, "file_iou": 1.0, "num_predicted": 1, "num_ground_truth": 1},
            {"seed_id": "b", "ok": False, "span_f1": 0.0, "file_iou": 0.0, "num_predicted": 0, "num_ground_truth": 2, "errors": ["err"]},
        ],
    }
